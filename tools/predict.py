...
def init_args():
    ...
    parser.add_argument('--model_path', default=r'/data1/cxy/icdaroutput/DBNet_resnet18_FPN_DBHead/checkpoint/model_best.pth', type=str)
    parser.add_argument('--input_folder', default='/data1/cxy/DBNET/test/input', type=str, help='img path for predict')
    parser.add_argument('--output_folder', default='/data1/cxy/DBNET/test/output', type=str, help='img path for output')
